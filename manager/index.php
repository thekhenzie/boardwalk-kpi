<?php
	...
	if( isset($_POST['btn-login']) ) {	
		...
		if( $count == 1 && $row['userPass']==$password ) {
            ...
            if( $_SESSION['userRole'] == "admin"){ header("Location: dashboards.php?deptId=1");}
...
<div class="vibrant-holder vibrant-holder-full" style="background-image:url('try.jpg')">
<div class="container">
    ...
    <form method="post" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	<button type="submit" class="btn btn-block btn-primary waves-effect  waves-light" name="btn-login">Sign In</button>
            </div>
