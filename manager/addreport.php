...
if( !isset($_SESSION['user']) ) {
    ...
    if( $_SESSION['userRole'] == "manager"){ 
        header("Location: ../manager/dashboards.php?deptId=".$userRow['deptId']);

    }
    if( $_SESSION['userRole'] == "employee"){
        header("Location: ../user/dashboards.php?deptId=".$userRow['deptId']);
...
<head>
    ...
    <title>Add Report | Boardwalk</title>
    ...
    <div class="columns">
        <div class="columns-row">
            <div class="column-left">
                ...
                <h4>Select...</h4>
                <a class="category selected"><b>1</b><span>Add Report</span></a>
				 <a href="reports.php?deptId=1" class="category"><b>2</b><span>View Reports</span></a>
            </div>
                    ...
                    <div class="field-table">
                        ...
                        <div class="field-row">
                            ...
                            <div>
                                ...
                                "width:335px" type="date" value=""> <span class="field-validation-valid"
