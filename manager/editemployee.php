    ...
    <div class="columns">
        <div class="columns-row">
            <div class="column-left">
                ...
                <h4>Select...</h4>
                <a class="category" href="addemployee.php"><b>1</b><span>Add Employee</span></a> <a class=
                "category selected"><b>2</b><span>View Employees</span></a>
            </div>
                ...
                <form action="" class="profile-picture surround" method="post">
                    <div class="field-table">
                        <div class="field-row">
                            ...
                            <h3><?php
									...
									if(isset($_POST['save'])){
										...
										$update = mysql_query( "UPDATE users SET userFname='$userFname', userLname='$userLname',userEmail='$userEmail'  WHERE userId='$userId'") or die(mysql_error());
										if($update){
											header("Location: employee.php?userId=".$userId."&message=success");
										}else{
                        ...
                        <div class="field-row">
                            ...
                            <div>
                                <input readonly name="userFname" placeholder="Department Name" required="" type="text" value=
                                "<?php echo ucfirst($row['userFname']); ?>" readonly>
                                <input readonly name="userLname" placeholder="Department Name" required="" type="text" value=
                                "<?php echo ucfirst($row['userLname']); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="field-row">
                            ...
                            <div>
                                <input readonly name="userEmail" placeholder="Description" required="" type="text" value=
                        ...
                        <div class="field-row">
                            ...
                            <div>
                                <input readonly name="userDate" placeholder="Description" required="" type="text" value=
                        ...
                        <div class="field-row">
                            ...
                            <div>
                                <input readonly name="deptName" placeholder="Department Head" required="" type="text" value=
                        ...
                        <div class="submit-row">
                            ...
                            <div>
                                ...
                                "button-green" href="viewemployee.php">Back</a>
                            </div>
                        </div>
                    </div>
                </form>
