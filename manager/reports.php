                                ...
                                <table class="kpis">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            "font-weight: bold;text-align:left;background-color:#f5f5f5;">PROJECT <br>TASK PARTICULARS</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#f5f5f5;">STATUS<br>(Complete,On-going,Not Started)</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#f5f5f5;">DUE DATE</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#f5f5f5;">NEXT STEPS</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#f5f5f5;">CHALLENGES/CONCERNS</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#f5f5f5;">CRITICAL LEVEL</th>
                                             <!--<th class="target" style=
