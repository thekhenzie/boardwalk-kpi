...
<body>
    ...
    $query = "UPDATE departments SET deptName='$deptName', deptDesc='$deptDesc', deptHead='$deptHead' WHERE deptId='$deptId'; UPDATE users SET userType=2 WHERE Name LIKE ('".$oldhead."'); UPDATE users SET userType=3 WHERE Name LIKE ('".$deptHead."');";
    // 
