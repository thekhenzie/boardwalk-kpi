...
if(isset($_POST['btn-signup'])) {
    ...
    if ($count==0) {
        ...
        $query = "INSERT INTO users(userFname, userLname, userName,userEmail,userPass, userDate,deptId,userRole) VALUES('$fname1','$lname1','$final','$email','$final','$date','$deptId','employee')";
