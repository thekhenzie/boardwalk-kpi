    ...
    <div class="tab-menu screen">
        ...
        <ul class="tab-menu">
            <li>
                ...
                <li>
                    <a href="dataentry.php?deptId=<?php echo $deptId; ?>"><svg class="init">
                            ...
                            <tbody>
                                ...
                                while($kpi3=mysql_fetch_assoc($res3)){
                                  ...
                                  <td class="edit screen">
                                    ...
                                    <a href="editkpi.php?kpiId='.$kpi3['kpiId'].'&deptId='.$kpi3['deptId'].'">
                                ...
                                if($kpi3['kpiType']==1){
                                    echo '
                                    <a class="button-green" title="" href="dataentry.php?deptId='.$kpi3['deptId'].'" data-bind="attr: { href: KpiEntryLink, title: KpiEntryTitle }, css: { "button-grey": HasEntries, "button-green: !HasEntries }" style="margin:0;padding:0 8px;width:65px">Add Data</a>';
                                }

                                if($kpi3['kpiType']==2){
                                    echo '
                                    <a  class="button-green" title="" style="margin:0;padding:0 8px;width:65px;background-color:#db7093" disabled="disabled">--</a>';
                                }
                                ...
                                if($kpi3['kpiType']==1){
                                echo '
                                <a href="kpi.php?disable=true&kpiId='.$kpi3['kpiId'].'&deptId='.$kpi3['deptId'].'" title="Disable" onclick="return confirm(\'Do you want to disable kpi '.$kpi3['kpiName'].'?\')"class="btn btn-info btn-sm"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></a>
                                ';}

                                if($kpi3['kpiType']==2){
                                echo '
                                <a href="kpi.php?enable=true&kpiId='.$kpi3['kpiId'].'&deptId='.$kpi3['deptId'].'" title="Enable" onclick="return confirm(\'Do you want to enable kpi '.$kpi3['kpiName'].'?\')" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span></a>
                                ';}

                                echo '
                                <a href="editkpi.php?kpiId='.$kpi3['kpiId'].'&deptId='.$kpi3['deptId'].'" title="Edit Data" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                <a href="kpi.php?action=delete&kpiId='.$kpi3['kpiId'].'&deptId='.$kpi3['deptId'].'" title="Delete Data" onclick="return confirm(\'Are you sure to delete the data '.$kpi3['kpiName'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                            </td>
