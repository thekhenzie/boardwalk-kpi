				...
				if(mysql_num_rows($sql) == 0){
					...
					while($row = mysql_fetch_assoc($sql)){
						...
						echo '
							...
							<td>
								<a href="editdepartments.php?deptId='.$row['deptId'].'" title="Edit Data" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
								<a href="viewdepartments.php?action=delete&deptId='.$row['deptId'].'" title="Delete Data" onclick="return confirm(\'Are you sure to delete the data '.$row['deptName'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
