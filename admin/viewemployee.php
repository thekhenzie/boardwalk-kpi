...
<html idmmzcc-ext-docid="468572160"><head>
    ...
    <title>View Manager | Boardwalk</title>
...
<div class="columns">
    <div class="columns-row">
        <div class="column-left">
            ...
            <h4>Select...</h4>
            <a href="addemployee.php" class="category"><b>1</b><span>Add Manager</span></a>
			 <a class="category selected"><b>2</b><span>View Managers</span></a>
		...
		<div class="report-header">
                            <div class="title">
                                <h1 id="h1Name"><?php echo $dep['deptName']; ?> Managers</h1>
		...
		<?php
            ...
            <table class="kpis">
				...
				<?php
					...
					$sql = mysql_query("SELECT userId,userFname,userLname,userEmail,userDate,d.deptName AS deptName FROM users u,departments d WHERE u.deptId=d.deptId AND userRole='manager' ORDER BY d.deptId,userLname ASC");
