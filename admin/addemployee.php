...
if(isset($_POST['btn-signup'])) {
    ...
    if ($count==0) {
        ...
        $query = "INSERT INTO users(userFname, userLname, userName,userEmail,userPass, userDate,deptId,userType,userRole,Name) VALUES('$fname1','$lname1','$final','$email','$final','$date','$deptId','2','manager','$Name')";
...
<head>
    ...
    <title>Add Manager | Boardwalk</title>
    ...
    <div class="columns">
        <div class="columns-row">
            <div class="column-left">
                ...
                <h4>Select...</h4>
                <a class="category selected"><b>1</b><span>Add Manager</span></a> <a class="category" href=
                "viewemployee.php"><b>2</b><span>View Managers</span></a>
            </div>
