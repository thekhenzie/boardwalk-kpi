...
--
-- Host: localhost
-- Generation Time: Nov 05, 2016 at 04:50 AM
...
(81, 23, '2016-10-01', 32, 32, 0, 0, 0, '2016-10-25'),
...
(5, '# Ideas put forward by individuals to team leaders  ', 'A', '', '# New ideas submitted by individuals to their team leader', '', '', '', 1),
...
(42, 'Tax collected', 'A', '', '$ Value of taxes collected', '', '', '', 4),
...
(114, 'Sales personnel retention rate', 'ABC', '[(A-B)/C]*100', ' # Sales personnel at the end of the reporting period', '# Sales personnel acquired during the reporting period', '# Customers at the beginning of the reporting period', '', 1);
...
(2, '% Growth in Recruitment', '0', '--', 1, 50, 1, 1),
...
(13, 'Cost to Litigate ', '0', '--', 3, 100, 1, 5),
(14, 'Cost per lawyer per day', '0', '--', 3, 100, 1, 5),
...
(20, '% Growth in PS Retention', '0', '--', 2, 100, 1, 1),
(22, '% Promoted PS', '0', '--', 2, 100, 1, 1),
...
(39, 'Dsa', 'On-going', '2016-10-23', '2016-10-23', '', '', 'Medium', 1),
