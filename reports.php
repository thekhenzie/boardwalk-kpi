...
<body>
    ...
    <div class="tab-menu screen">
        ...
        <ul class="tab-menu">
            ...
            <li class="selected no-print">
                ...
                style="fill: black;" xmlns="http://www.w3.org/2000/svg"></path></svg><span class="no-print">Reports</span>
            </li>
            <li>
                        ...
                        <div class="holder" id="dvReport">
                            ...
                            <table class="kpis">
                                <thead>
                                    <tr>
                                        <th colspan="15" style=
                                        "font-weight: bold;text-decoration:underline;text-align:center;background-color:#fdd90e;height:20px;">
                                        ACCOMPLISHMENTS</th>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
                                        <th colspan="15" style=
                                        "font-weight: bold;text-decoration:underline;text-align:left;color:white;background-color:#ad26ff;">
                                    ...
                                    <tr>
                                        ...
                                        $ave=mysql_fetch_array($strQuery);
                                            ...
                                            echo '
                                                ...
                                                if($temp!=0){
                                                    if($ave['Average']<=89){
                                                    echo '<td style="width:50px;text-align:center;background-color: #FF8C69">'.$ave['Average'].'</td>';
                                                    }
                                                    else if($ave['Average']>90){
                                                    echo '<td style="width:50px;text-align:center;background-color: #FBEC5D">'.$ave['Average'].'</td>';
                                                    }
                                                }else {echo '<td style="width:50px;text-align:center;">0</td>';}
    ...
    <tr><td></td></tr>
                                ...
                                <table class="kpis">
                                    <thead>
                                        <tr>
                                            <th colspan="15" style=
                                            "font-weight: bold;text-decoration:underline;text-align:left;background-color:#ad26ff;color:white">
    ...
    <tr><td></td></tr>
                                ...
                                <table class="kpis">
                                    ...
                                    <thead>
                                        <tr>
                                            <th style=
                                            "width: 30px;font-weight: bold;text-align:center;background-color:#ad26ff;color:white">
                                            </th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:left;background-color:#ad26ff;color:white">PROJECT <br>TASK PARTICULARS</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#ad26ff;color:white">STATUS<br>(Complete,On-going,Not Started)</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#ad26ff;color:white">DUE DATE</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#ad26ff;color:white">NEXT STEPS</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#ad26ff;color:white">CHALLENGES/CONCERNS</th>
                                            <th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#ad26ff;color:white">CRITICAL LEVEL</th>
                                             <!--<th class="target" style=
                                            "font-weight: bold;text-align:center;background-color:#ad26ff;color:white">TOOLS</th>-->
                                    ...
                                    <tbody>
                                    ';
                                    if (date('D')=="Mon"){$monday = date('Y-m-d');}    
                                    else{$monday = date('Y-m-d',strtotime("-1 Monday"));}
                                    $monday2 = date('Y-m-d',strtotime("0 Saturday"));
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            +</td>
                                            <td colspan="6">
                                                <a href="addreportpp.php?deptId='.$deptId.'" rel="facebox" style="color:#000000">Add new report</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>';
    ...
    <tr><td></td></tr>
                            ...
                            <button class="button-green no-print" onclick="window.print()">Print this page</button>
