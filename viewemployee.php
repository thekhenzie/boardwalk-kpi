...
<div class="columns">
    <div class="columns-row">
		...
		<?php
            ...
            <table class="kpis">
				<tr>
					<th class="screen no-print">Edit</th>
                    ...
                    <th class="screen no-print" style="text-align:left;">Tools</th>
				</tr>
				<?php
				
					$sql = mysql_query("SELECT userId,userFname,userLname,userEmail,userDate,d.deptName AS deptName FROM users u,departments d WHERE u.deptId=d.deptId ORDER BY d.deptId,userLname ASC");
