<?php
    ...
    $ress=mysql_query("SELECT * FROM departments WHERE deptId=1");
                ...
                <div data-accord="1" style="">
                    <?php       
                                ...
                                while($depts=mysql_fetch_assoc($res2)){
                                        ...
                                        echo '
                                        <a href="'.$depts['reportPage'].'" class="category">
                                        <b>'.$no.'</b>
                ...
                <table class="kpi-entry">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width:80px;vertical-align:top">
                       <?php
				
					echo '        
                            </th>
							<th class="actual past" style="width:80px;">'.date('M Y', strtotime("-10 month")).'</th>
					...
					';
						...
						$res1=mysql_query("SELECT * FROM kpis WHERE deptId=1");
					...
					';
							...
							$q=mysql_query("SELECT * FROM datakpi WHERE kpiId=('".$kpis['kpiId']."') AND dkDate < ('".$today."') ORDER BY dkDate ASC LIMIT 10 ");
							$rows=mysql_num_rows($q);
								if ($rows<10) {
									for($x=0;$x<=(9-$rows);$x++){
									echo '<td class="actual past"><input class="actual" tabindex="1" type="text" value="0" readonly></td>';}
							...
							if($rowsadd==0){
								echo '
								<td class="actual today"><a href="adddatakpipp.php?kpiId='.$datatemp['kpiId'].'" rel="facebox" ><button class="button-green" style="background-color:#fdd90e;color:black">Add Data</button></a></td>';
							}
							else echo '
								<td class="actual today"><input class="actual" maxlength="15" tabindex="6" type="text" value="'.$datatoday['dkResult'].'"readonly></td>';
							
							echo '
                            
							<td class="actual future"><input class="actual" maxlength="15" tabindex="7" type="text" readonly></td>


                    </tbody>';
                    /*<tfoot class="screen">
                        <tr class="foot-spacer">
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            ...
                            <td data-view="M">&nbsp;</td>
                            <td class="screen">&nbsp;</td>
                            <td class="media-hide" data-view="S" style="display: none;">&nbsp;</td>
                            <td data-view="S" style="display: none;">&nbsp;</td>
                            <td data-view="S" style="display: none;">&nbsp;</td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            ...
                            <td style="text-align:center">
                                <a class="button-green sprite" data-bind="click: saveClick" id=
                                "aSaveEntries"><span>Save</span></a>
                            </td>
                            <td data-view="M">&nbsp;</td>
                            <td>&nbsp;</td>
                            <td class="media-hide" data-view="S" style="display: none;">&nbsp;</td>
